        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    width = 100;
                    height = 900;
                    return [4 /*yield*/, (0, ResImF_1.default)("OrSImage/fjord.jpg", width, height, "OrSImage/".concat(width, "-").concat(height, "-f3.jpg"))];
                case 1:
                    _a.sent();
